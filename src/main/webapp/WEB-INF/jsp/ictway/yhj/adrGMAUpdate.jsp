										...
										<table>
											...
											<tr>
												...
												<td><input id="cmpnyTeamNm" name="cmpnyTeamNm" type="text"
													size="50" value="<c:out value="${resultVO.cmpnyTeamNm}" />" maxlength="50" class="f_txt w_full"></input>
												</td>
											</tr>
											<tr>
												<td class="lb"><label for="cmpnyClsfNm">직급</label></td>
												<td><input id="cmpnyClsfNm" name="cmpnyClsfNm" type="text"
													size="50" value="<c:out value="${resultVO.cmpnyClsfNm}" />" maxlength="50" class="f_txt w_full"></input>
												</td>
											</tr>
											<tr>

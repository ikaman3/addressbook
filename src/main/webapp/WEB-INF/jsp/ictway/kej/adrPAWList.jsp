							...
							<div id="contents" class="content">
								...
								<div class="condition">
									...
									<form:form modelAttribute="searchVO" name="searchListForm" method="post">
										...
										<span class="item f_search">
											...
											<button class="btn" type="submit" onclick="selectAdrPAWList('1'); return false;"><spring:message code='button.inquire' /></button><!-- 조회 -->
										</span>
										<a href="javascript:void(0);" onclick="selectAdrPAWRegist();" class="item btn btn_blue_46 w_100"><spring:message code="button.create" /></a><!-- 등록 -->
									</form:form>
									<!-- 검색 form 끝 -->
								</div>
								<!--// 검색조건 -->
									...
									<table>
										...
										<c:forEach items="${resultList}" var="resultVO" varStatus="status">
											<tr>
												...
												<td class="al">
													<a href="javascript:void(0);" onclick="selectAdrDetail('<c:out value="${resultVO.adrPAWId}"/>'); return false;" class="lnk">
								...
								<div class="board_list_bot">
									<div class="paging" id="paging_div">
										<ul>
											<ui:pagination paginationInfo="${paginationInfo}" type="renew" jsFunction="selectAdrPAWList" />
										</ul>
									</div>
								</div>
								<!--// 게시판 -->

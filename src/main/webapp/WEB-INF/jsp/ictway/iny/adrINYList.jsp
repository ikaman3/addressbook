...
<script type="text/javascript">
	...
	//주소록 목록조회
	function selectAdrINYList(pageIndex){
					...
					<div class="layout">
						...
						<div class="content_wrap">
							<div id="contents" class="content">
								...
								<p class="txt_1">INY 주소록 목록 입니다.</p>
								...
								<div class="condition">
									...
									<form:form modelAttribute="searchVO" name="searchListForm" method="post">
										...
										<span class="item f_search">
											...
											<button class="btn" type="submit" onclick="selectAdrINYList('1'); return false;"><spring:message code='button.inquire' /></button><!-- 조회 -->
										</span>
										<a href="javascript:void(0);" onclick="selectAdrINYRegist();" class="item btn btn_blue_46 w_100"><spring:message code="button.create" /></a><!-- 등록 -->
									</form:form>
									<!-- 검색 form 끝 -->
								</div>
								<!--// 검색조건 -->
								...
								<div class="board_list_bot">
									<div class="paging" id="paging_div">
										<ul>
											<ui:pagination paginationInfo="${paginationInfo}" type="renew" jsFunction="selectAdrINYList" />
										</ul>
									</div>
								</div>
								<!--// 게시판 -->
